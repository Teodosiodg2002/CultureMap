"""
Django settings for service_usuarios project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-usuarios-key')
...
# Custom User Model (CRITICAL for this service)
...
ROOT_URLCONF = 'service_usuarios.urls'
...
WSGI_APPLICATION = 'service_usuarios.wsgi.application'
...
SIMPLE_JWT = {
    ...
    # Puedes añadir aquí 'SIGNING_KEY': SECRET_KEY si quieres forzarlo,
    # pero por defecto usa la SECRET_KEY de Django.
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'loki': {
            ...
            'tags': {'app': 'culturemap', 'service': 'service-usuarios'},
            'version': '1',
        },
    },
    'root': {
