...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-lugares-key')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Custom Authentication for Stateless JWT (Microservices)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'loki': {
            ...
            'tags': {'app': 'culturemap', 'service': 'service-lugares'},
            'version': '1',
        },
    },
    'root': {
