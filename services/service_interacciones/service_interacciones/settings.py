...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-interacciones-key')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'interacciones.authentication.StatelessJWTAuthentication',
    ),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'loki': {
            ...
            'tags': {'app': 'culturemap', 'service': 'service-interacciones'},
            'version': '1',
        },
    },
    'root': {
